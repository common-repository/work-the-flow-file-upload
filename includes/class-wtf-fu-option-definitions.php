    ...
    private function __construct() {
        ...
        $this->all_pages_default_options = array(
           ...
           wtf_fu_DEFAULTS_SHORTCODE_LISTFILES_KEY => array(
                ...
                'line_format' => "<tr><td class=number>%%NUMBER%%</td><td class=thummbnail>%%THUMBNAIL%%</td><td class=vertical>%%FILENAME%%<br />%%AUDIO%%</td><td class=icon>%%ICON%%&nbsp;%%FILESIZE%%</td></tr>",   
                'filetimeformat' => "M d Y H:i:s",
                'download_links' => '1',
                'gallery' => '1',
                'use_public_dir' => '0',
                'email_format' => '0'
        ...
        $this->all_pages_default_labels = array(
           ...
           wtf_fu_DEFAULTS_SHORTCODE_LISTFILES_KEY => array(
                ...
                'line_format' => "The format for a single file item as an html table row. The field placeholders %%NUMBER%%, %%THUMBNAIL%%, %%FILENAME%%, %%ICON%%, %%FILESIZE%%, and %%FILEDATETIME%% may be used to construct the row. e.g. "
               ...
               'filetimeformat' => "The php date format string to use with the %%FILEDATETIME%% placeholder. Please see http://php.net/manual/en/function.date.php for a list of php date formatting codes.",
